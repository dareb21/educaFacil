    ...
    <div class="container">
        ...
        @foreach($cursos as $curso)
            <div class="course-card">
                <h3 class="course-title">{{ $curso->name }}</h3>
                <p class="course-description">{{ $curso->desc }}</p>
                <a href="{{route('course_dashboard', ['cursoId' => $curso->id] ) }}" class="course-button">Ver más</a>
